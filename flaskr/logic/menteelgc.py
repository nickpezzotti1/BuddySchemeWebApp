...
class MenteeLogic():
    ...
    def mentee_mentor_list(self, request):
        ...
        try:
            mentor_list = self._allocation_handler.get_mentors(
            ...
            for mentor in mentor_list:
                ...
                mentor_list_data[mentor_k_number] = self._student_handler.get_user_data(
                    current_user.scheme_id, mentor_k_number)
